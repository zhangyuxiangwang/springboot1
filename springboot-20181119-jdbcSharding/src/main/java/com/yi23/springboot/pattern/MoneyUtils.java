...
public class MoneyUtils {
     ...
     */
    public static String convertMoneyToCapital(String amount) throws IllegalArgumentException {
        // 去掉分隔符
        ...
        Matcher matcher = Pattern.compile("^(0|[1-9]\\d{0,11})\\.(\\d\\d)$").matcher(amount);
        if (!matcher.find()) {
